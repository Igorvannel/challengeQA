...
test('Validation du champ Prénom (lettres uniquement)', async ({ page }) => {
    ...
    expect(isFirstNameErrorDisplayed).toBe(true);  // Vérifie que l'erreur "Please fill in this field" est affichée
    ...
    expect(isInvalidFirstNameErrorDisplayed).toBe(true);  // Vérifie que l'erreur "Please fill in this field" est affichée
  });
